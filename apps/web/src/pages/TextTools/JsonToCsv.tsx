  ...
  return (
    <>
      ...
      <div className="max-w-[600px] mx-auto py-8 px-4">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-md">
          ...
          <p className="text-sm text-gray-600 mb-4">
            JSON to CSV変換ツールは、JSONデータをCSV形式に変換する無料のオンラインツールです。APIレスポンスやデータベースのエクスポートデータなど、JSON形式のデータをExcelやスプレッドシートで扱いやすいCSVに変換できます。
          </p>
        </div>
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-md">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            <li>• JSON配列をCSVに変換</li>
            <li>• Excel対応のUTF-8 BOM付きDL</li>
            <li>• ネストされたオブジェクトに対応</li>
            <li>• 完全無料、ブラウザ上で動作</li>
          </ul>
        </div>
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-md">
          ...
          <div className="text-sm text-gray-600 space-y-3">
            <div>
              <p className="font-medium">Q. どのようなJSON形式に対応していますか？</p>
              <p>A. オブジェクトの配列形式に対応しています。</p>
            </div>
            <div>
              <p className="font-medium">Q. 文字化けしませんか？</p>
              <p>A. UTF-8 BOM付きでダウンロードするため、Excelでも正しく表示されます。</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        {/* 関連ツール */}
        <RelatedTools currentPath="/text/json-to-csv" />
