...
function Base64Encoder() {
  useToolUsageTracking('/text/base64', 'Base64エンコード')
  ...
  return (
    <>
      ...
      <div className="max-w-[800px] mx-auto py-8 px-4">
        <h2 className="text-2xl font-semibold mb-8 text-center">Base64エンコード/デコード</h2>
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            placeholder={mode === 'encode' ? 'エンコードしたいテキストを入力' : 'デコードしたいBase64文字列を入力'}
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-md">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            <li>• <strong>エンコード</strong>: テキストをBase64形式に変換</li>
            <li>• <strong>デコード</strong>: Base64文字列を元のテキストに戻す</li>
            <li>• 日本語（UTF-8）に対応しています</li>
