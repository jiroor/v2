  ...
  return (
    <>
      ...
      <div className="max-w-[800px] mx-auto py-8 px-4">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-md">
          ...
          <p className="text-sm text-gray-600 mb-4">
            テキストエスケープツールは、テキストを様々な形式にエスケープする無料のオンラインツールです。HTML、URL、JSON、正規表現、SQL、Base64の6種類に対応しています。プログラミングやデータ処理に役立ちます。
          </p>
        </div>
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-md">
          ...
          <div className="text-sm text-gray-600 space-y-3">
            <div>
              <p className="font-medium">Q. エスケープとは何ですか？</p>
              <p>A. 特殊な意味を持つ文字を、別の形式に変換して安全に扱えるようにすることです。</p>
            </div>
            <div>
              <p className="font-medium">Q. アンエスケープ（復元）はできますか？</p>
              <p>A. 別途「テキストアンエスケープ」ツールをご利用ください。</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        {/* 関連ツール */}
        <RelatedTools currentPath="/text/escape" />
