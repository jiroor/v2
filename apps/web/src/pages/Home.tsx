...
const toolIcons: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  '/text/width': WidthConverterIcon,
  '/text/kana': CaseConverterIcon,
  '/text/romaji': CaseConverterIcon,
  '/text/notepad': LoremIpsumIcon,
  '/text/timestamp': UnixTimestampIcon,
  '/text/reverse': TextSorterIcon,
  '/text/line-number': TextStatisticsIcon,
    ...
    <>
      ...
      <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-6 max-md:grid-cols-1">
        ...
        <Link
          ...
          className="flex flex-col items-center bg-white border border-gray-200 rounded-lg p-6 transition-all duration-200 cursor-pointer no-underline text-inherit hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:bg-[#fef3c7] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#d97706] focus-visible:outline-offset-2 focus-visible:-translate-y-0.5 focus-visible:shadow-[0_4px_12px_rgba(0,0,0,0.08)] group"
        >
          <WidthConverterIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">全角半角変換</h3>
          <p className="text-gray-600 text-sm text-center">全角⇔半角、カタカナ変換</p>
        </Link>
        ...
        >
          <CaseConverterIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">ひらがなカタカナ変換</h3>
          <p className="text-gray-600 text-sm text-center">ひらがな⇔カタカナ</p>
        </Link>
        ...
        >
          <CaseConverterIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">ローマ字変換</h3>
          <p className="text-gray-600 text-sm text-center">ローマ字⇔ひらがな</p>
        </Link>
        ...
        >
          <LoremIpsumIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">簡易メモ帳</h3>
          <p className="text-gray-600 text-sm text-center">自動保存メモ</p>
        </Link>
        ...
        >
          <UnixTimestampIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">タイムスタンプ生成</h3>
          <p className="text-gray-600 text-sm text-center">日時タイムスタンプ</p>
        </Link>
        ...
        >
          <TextSorterIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">逆順変換</h3>
          <p className="text-gray-600 text-sm text-center">テキストを逆順に</p>
        </Link>
        ...
        >
          <TextStatisticsIcon className="w-12 h-12 mb-4 text-gray-900 transition-all duration-200 group-hover:scale-110 group-hover:text-[#d97706]" />
          <h3 className="text-xl font-semibold mb-2 text-center">行番号追加</h3>
          <p className="text-gray-600 text-sm text-center">行番号を付与</p>
        </Link>
